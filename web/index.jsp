...
<div style="max-height:100%">
    <img class="mySlides"  src="Blood2.jpg" width="80px" height="30px" >
  <img class="mySlides"  src="BloodBank2.jpg" width="80px" height="30px">
</div>
<script>
var myIndex = 0;
carousel();
...
<body>
  ...
  <%
       ...
       {
        %>
<center><font color="red" size="5"> Form submitted successfully. You will get notification within 24 hours.</font></center>
     <%  }
  %>    
<%
